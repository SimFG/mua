...
class GalleryData:
    def __init__(self):
        ...
        self.control_groups = [
            ...
            ControlGroup(
                name="cdc",
                label="CDC Tools",
                icon=ft.icons.CLOSED_CAPTION_OUTLINED,
    ...
    def list_control_dirs(self, dir):
        file_path = os.path.join(str(Path(__file__).parent), "tools", dir)
        control_dirs = [
            f
    ...
    def list_example_files(self, control_group_dir, control_dir):
        file_path = os.path.join(
            str(Path(__file__).parent), "tools", control_group_dir, control_dir
        )
            ...
            for control_dir in self.list_control_dirs(control_group_dir.name):
                ...
                for file in self.list_example_files(
                    ...
                    if module_name in sys.modules:
                        ...
                        file_path = os.path.join(
                            str(Path(__file__).parent), "tools", file_name
                        )
